...
object DataDummy {
    ...
    fun generateRemoteDummyMovies(): List<ModelResponse> {
        val movies = ArrayList<ModelResponse>()
        movies.add(
            ModelResponse("399579",
            "Alita: Battle Angel",
            "When Alita awakens with no memory of who she is in a future world she does not recognize, she is taken in by Ido, a compassionate doctor who realizes that somewhere in this abandoned cyborg shell is the heart and soul of a young woman with an extraordinary past.",
            "https://www.themoviedb.org/t/p/w600_and_h900_bestv2/xRWht48C2V8XNfzvPehyClOvDni.jpg",
            "Action, Science Fiction, Adventure",
    ...
    fun generateRemoteDummyTvShows(): List<ModelResponse> {
        val tvShows = ArrayList<ModelResponse>()
        tvShows.add(
            ModelResponse("1416",
            "Grey's Anatomy",
            "Follows the personal and professional lives of a group of doctors at Seattle’s Grey Sloan Memorial Hospital.",
